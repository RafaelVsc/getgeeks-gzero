...
Remove User
    ...
    # Quando faço uma solicitação DELETE na rota /users 
    ${response}         DELETE User     ${token}

    # Então deve devolver o status code 204 no content
    Status Should Be    204         ${response}

    # E quando faço solicitação GET na rota /users com o mesmo token
    ${response}     GET User        ${token}

    # Então deve retornar o Status code 404 not found
